...
- Add experimental `collapse_spatial_variance` option to
  ...
  [\#263](https://github.com/pbs-assess/sdmTMB/issues/263)
...
- Extend
  ...
  [\#447](https://github.com/pbs-assess/sdmTMB/issues/447)

- Add new experimental function
  [`get_range_edge()`](https://pbs-assess.github.io/sdmTMB/reference/get_range_edge.md)
...
- Add new function
  [`cv_to_waywiser()`](https://pbs-assess.github.io/sdmTMB/reference/cv_to_waywiser.md)
  ...
  predictions. [\#193](https://github.com/pbs-assess/sdmTMB/issues/193)
...
- Add vignette demonstrating how to fit zero-one-inflated beta (ZOIB)
  ...
  predictions. [\#440](https://github.com/pbs-assess/sdmTMB/issues/440)
  [\#441](https://github.com/pbs-assess/sdmTMB/issues/441)

- Fix issue with ggeffects with multiple smoothers + offsets.
  [\#450](https://github.com/pbs-assess/sdmTMB/issues/450)

- Improve `t2()` printing and appearance in
  [`tidy.sdmTMB()`](https://pbs-assess.github.io/sdmTMB/reference/tidy.sdmTMB.md).
  [\#415](https://github.com/pbs-assess/sdmTMB/issues/415)
  [\#472](https://github.com/pbs-assess/sdmTMB/issues/472)
...
- Add argument to fix probability of extreme events for `*_mix()`
  ...
  [\#318](https://github.com/pbs-assess/sdmTMB/issues/318)
  [\#474](https://github.com/pbs-assess/sdmTMB/issues/474)

- Add beta-binomial family
  ([`betabinomial()`](https://pbs-assess.github.io/sdmTMB/reference/families.md))
  for modeling overdispersed binomial data. Supports logit and cloglog
  links, and includes proper residuals support.

- Add new function
  [`get_weighted_average()`](https://pbs-assess.github.io/sdmTMB/reference/get_index.md)
  ...
  [`get_cog()`](https://pbs-assess.github.io/sdmTMB/reference/get_index.md)
...
- **Fix barrier model implementation**. The SPDE input matrices for the
  ...
  [\#457](https://github.com/pbs-assess/sdmTMB/issues/457)

- Add vignette on age (or length) composition standardization. To help
  with this add a new experimental function
  [`make_category_svc()`](https://pbs-assess.github.io/sdmTMB/reference/make_category_svc.md).
...
- Add `emmeans` support for delta/hurdle models. Use `model = 1` for the
  ...
  [\#247](https://github.com/pbs-assess/sdmTMB/issues/247)
  [\#249](https://github.com/pbs-assess/sdmTMB/issues/249)
...
- Let
  ...
  `newdata` supplied.
  [\#465](https://github.com/pbs-assess/sdmTMB/issues/465)

- Fix issue with fold logic in LFO (leave-future-out) cross validation
  for `lfo_forecast > 1`.
  [\#454](https://github.com/pbs-assess/sdmTMB/issues/454) Thanks to
  [@Joseph-Barss](https://github.com/Joseph-Barss).

- Add
  [`update.sdmTMB()`](https://pbs-assess.github.io/sdmTMB/reference/update.sdmTMB.md)
  so that the mesh argument doesn’t have to be specified if model is
  loaded in a fresh session.
  [\#461](https://github.com/pbs-assess/sdmTMB/issues/461)

- Change default in
  [`get_index()`](https://pbs-assess.github.io/sdmTMB/reference/get_index.md)
  ...
  [\#456](https://github.com/pbs-assess/sdmTMB/issues/456)

- Only retain Newton update parameters if they improve the objective
  function. [\#455](https://github.com/pbs-assess/sdmTMB/issues/455)

- Only run Newton updates if maximum absolute gradient is `>= 1e-9` to
  save time. [\#455](https://github.com/pbs-assess/sdmTMB/issues/455)
...
- Add `observation_error` argument to
  ...
  observation error.
  [\#431](https://github.com/pbs-assess/sdmTMB/issues/431)

### Minor improvements and fixes

- Change the default in
  [`dharma_residuals()`](https://pbs-assess.github.io/sdmTMB/reference/dharma_residuals.md)
...
- Fix bug in simulation with time-varying AR(1) when using the
  [`project()`](https://pbs-assess.github.io/sdmTMB/reference/project.md)
...
- Add
  [`get_eao()`](https://pbs-assess.github.io/sdmTMB/reference/get_index.md)
  to calculate effective area occupied.

- Allow predicting on new data with `t2()` smoothers.
  [\#413](https://github.com/pbs-assess/sdmTMB/issues/413)

- Add priors for `breakpt()` and `logistic()` parameters.
  [\#403](https://github.com/pbs-assess/sdmTMB/issues/403)

- Add priors on time-varying SD parameters (`sigma_V`).

- Add [`cAIC()`](https://pbs-assess.github.io/sdmTMB/reference/cAIC.md)
  for calculating *conditional* AIC. Theory based on
  ...
  [\#383](https://github.com/pbs-assess/sdmTMB/issues/383)
  [\#387](https://github.com/pbs-assess/sdmTMB/issues/387)
...
- At experimental function
  [`get_index_split()`](https://pbs-assess.github.io/sdmTMB/reference/get_index.md),
...
- Fix bug in a check in
  ...
  [\#427](https://github.com/pbs-assess/sdmTMB/issues/427)
...
- Add check for `Inf`/`-Inf` values before fitting.
  [\#408](https://github.com/pbs-assess/sdmTMB/issues/408)

- Add linear component of smoothers to
  [`tidy()`](https://generics.r-lib.org/reference/tidy.html).
  [\#90](https://github.com/pbs-assess/sdmTMB/issues/90)

- Add time varying AR(1) correlation to
  [`tidy()`](https://generics.r-lib.org/reference/tidy.html) and
  [`print()`](https://rdrr.io/r/base/print.html).
  [\#374](https://github.com/pbs-assess/sdmTMB/issues/374)
...
- Fix bug in `est` column when predicting on new data with Poisson-link
  ...
  [\#389](https://github.com/pbs-assess/sdmTMB/issues/389)
...
- Add progress bar to
  [`simulate.sdmTMB()`](https://pbs-assess.github.io/sdmTMB/reference/simulate.sdmTMB.md).
  [\#346](https://github.com/pbs-assess/sdmTMB/issues/346)

- Add AUC and TSS examples to cross validation vignette.
  [\#268](https://github.com/pbs-assess/sdmTMB/issues/268)

- Add `model` (linear predictor number) argument to
  [`coef()`](https://rdrr.io/r/stats/coef.html) method. Also, write
  documentation for
  [`?coef.sdmTMB`](https://pbs-assess.github.io/sdmTMB/reference/coef.sdmTMB.md).
  [\#351](https://github.com/pbs-assess/sdmTMB/issues/351)

- Add helpful error message if some coordinates in
  [`make_mesh()`](https://pbs-assess.github.io/sdmTMB/reference/make_mesh.md)
  are `NA`. [\#365](https://github.com/pbs-assess/sdmTMB/issues/365)

- Add informative message if fitting with an offset but predicting with
  offset argument left at `NULL` on `newdata`.
  [\#372](https://github.com/pbs-assess/sdmTMB/issues/372)
...
- Fig bug in `exponentiate` argument for
  ...
  [\#353](https://github.com/pbs-assess/sdmTMB/issues/353)

- Fix bug in prediction from
  [`delta_truncated_nbinom1()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  and
  [`delta_truncated_nbinom2()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  ...
  [\#350](https://github.com/pbs-assess/sdmTMB/issues/350)
...
- Fix bug in `est_non_rf1` and `est_non_rf2` columns when all the
  ...
  - including IID random intercepts or time-varying coefficients See
    [\#342](https://github.com/pbs-assess/sdmTMB/issues/342). Thanks to
...
- Fix delta-gamma binomial link printing for `type = 'poisson-link'`
  [\#340](https://github.com/pbs-assess/sdmTMB/issues/340)
...
- Fix bugs for
  [`nbinom1()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  and
  [`nbinom2_mix()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  simulation.
...
- Add theoretical quantile residuals for the generalized gamma
  ...
  [\#333](https://github.com/pbs-assess/sdmTMB/issues/333)
...
- Simplify the internal treatment of extra time slices (`extra_time`).
  [\#329](https://github.com/pbs-assess/sdmTMB/issues/329) This is much
  less bug prone and also fixes a recently introduced bug.
  [\#335](https://github.com/pbs-assess/sdmTMB/issues/335) This can
  slightly affect model results compared to the previous approach if
...
- Add check if prediction coordinates appear outside of fitted
  coordinates. [\#285](https://github.com/pbs-assess/sdmTMB/issues/285)

- Fix memory issue with Tweedie family on large datasets.
  [\#302](https://github.com/pbs-assess/sdmTMB/issues/302)
...
- Add new `"mle-mvn"` type to
  [`residuals.sdmTMB()`](https://pbs-assess.github.io/sdmTMB/reference/residuals.sdmTMB.md)
...
- Fix bug in
  [`sanity()`](https://pbs-assess.github.io/sdmTMB/reference/sanity.md)
  ...
  [\#324](https://github.com/pbs-assess/sdmTMB/issues/324)
...
- Issue error if `time` column has NAs.
  [\#298](https://github.com/pbs-assess/sdmTMB/issues/298)
  [\#299](https://github.com/pbs-assess/sdmTMB/issues/299)
...
- Poisson-link delta models now use a `type` argument in
  [`delta_gamma()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  and
  [`delta_lognormal()`](https://pbs-assess.github.io/sdmTMB/reference/families.md).
  [`delta_poisson_link_gamma()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  and
  [`delta_poisson_link_lognormal()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  are deprecated.
  [\#290](https://github.com/pbs-assess/sdmTMB/issues/290)
...
- Force rebuild of CRAN binaries to fix issue with breaking Matrix ABI
  ...
  [\#288](https://github.com/pbs-assess/sdmTMB/issues/288)
  [\#287](https://github.com/pbs-assess/sdmTMB/issues/287)
...
- Add check for factor random intercept columns in `newdata` to avoid a
  crash. [\#278](https://github.com/pbs-assess/sdmTMB/issues/278)
  [\#280](https://github.com/pbs-assess/sdmTMB/issues/280)

- Improve warnings/errors around use of `do_index = TRUE` and
  [`get_index()`](https://pbs-assess.github.io/sdmTMB/reference/get_index.md)
  if `newdata = NULL`.
  [\#276](https://github.com/pbs-assess/sdmTMB/issues/276)

- Fix prediction with `offset` when `newdata` is `NULL` but `offset` is
  specified. [\#274](https://github.com/pbs-assess/sdmTMB/issues/274)

- Fix prediction failure when both `offset` and `nsim` are provided and
  model includes `extra_time`.
  [\#273](https://github.com/pbs-assess/sdmTMB/issues/273)
...
- Fix a bug predicting on new data with a specified offset and
  `extra_time`. [\#270](https://github.com/pbs-assess/sdmTMB/issues/270)

- Add warning around non-factor handling of the `spatial_varying`
  formula. [\#269](https://github.com/pbs-assess/sdmTMB/issues/269)

- Add experimental
  [`set_delta_model()`](https://pbs-assess.github.io/sdmTMB/reference/set_delta_model.md)
...
- Add anisotropic range printing.
  [\#149](https://github.com/pbs-assess/sdmTMB/issues/149) by
...
- Move
  [`dharma_residuals()`](https://pbs-assess.github.io/sdmTMB/reference/dharma_residuals.md)
  to [sdmTMBextra](https://github.com/pbs-assess/sdmTMBextra) to reduce
  heavy dependencies.
...
- Various fixes to pass CRAN checks.
  [\#158](https://github.com/pbs-assess/sdmTMB/issues/158)
...
- ‘offset’ argument can now be a character value indicating a column
  ...
  validation. [\#165](https://github.com/pbs-assess/sdmTMB/issues/165)

- Fix parallel cross validation when using an offset vector.
  [\#165](https://github.com/pbs-assess/sdmTMB/issues/165)

- Add leave-future-out cross validation functionality.
  [\#156](https://github.com/pbs-assess/sdmTMB/issues/156)
...
- Add anisotropy to [`print()`](https://rdrr.io/r/base/print.html)
  [\#157](https://github.com/pbs-assess/sdmTMB/issues/157)

- Fix `predict(..., type = "response", se_fit = TRUE)`, which involves
  issuing a warning and sticking to link space.
  [\#140](https://github.com/pbs-assess/sdmTMB/issues/140)
...
- Add mixture families:
  [`gamma_mix()`](https://pbs-assess.github.io/sdmTMB/reference/families.md),
  [`lognormal_mix()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  and associated delta/hurdle families:
  [`delta_gamma_mix()`](https://pbs-assess.github.io/sdmTMB/reference/families.md),
  [`delta_lognormal_mix()`](https://pbs-assess.github.io/sdmTMB/reference/families.md).
  These families feature a mixture of two distributions with different
  means but shared variance parameters.

- Add
  [`delta_beta()`](https://pbs-assess.github.io/sdmTMB/reference/families.md)
  family.
...
- Export previously experimental
  ...
  [`plot_anisotropy2()`](https://pbs-assess.github.io/sdmTMB/reference/plot_anisotropy.md).
...
- Let `sims_var` work with multiple spatially varying slopes (`zeta_s`);
  ...
  [\#107](https://github.com/pbs-assess/sdmTMB/issues/107)
...
- Add vignettes on visreg, ggeffects, and delta families (thanks J.
  Indivero!) [\#83](https://github.com/pbs-assess/sdmTMB/issues/83)
  [\#87](https://github.com/pbs-assess/sdmTMB/issues/87)
  [\#89](https://github.com/pbs-assess/sdmTMB/issues/89) Forecasting and
  presence-only vignettes to be merged in soon.

- Add support for emmeans package. See
  [`?emmeans.sdmTMB`](https://pbs-assess.github.io/sdmTMB/reference/emmeans.sdmTMB.md)
  for examples.
...
- Add support for effects package. The
  ...
  shortly. [\#101](https://github.com/pbs-assess/sdmTMB/issues/101)
...
- Add `bayesian` argument, which when `TRUE` adds Jacobian adjustments
  ...
  [\#95](https://github.com/pbs-assess/sdmTMB/issues/95)
...
- Add support for ‘delta’ (or ‘hurdle’) models. See examples and
  documentation in
  [`?sdmTMB`](https://pbs-assess.github.io/sdmTMB/reference/sdmTMB.md).
  This has resulted in a substantial restructuring of the internal model
...
- Add compatibility with the ‘visreg’ package for visualizing
  ...
  [`?visreg_delta`](https://pbs-assess.github.io/sdmTMB/reference/visreg_delta.md)
  for examples.
...
- Fix bug in predictions with `poly(..., raw = FALSE)` on newdata.
  [\#77](https://github.com/pbs-assess/sdmTMB/issues/77)

## sdmTMB 0.0.21.9009

- Add experimental
  [`sdmTMB_stacking()`](https://pbs-assess.github.io/sdmTMB/reference/sdmTMB_stacking.md)
  for ensemble model stacking weights.

- Add fake mesh if random fields are all off.
  [\#59](https://github.com/pbs-assess/sdmTMB/issues/59)
...
- Add
  [`add_utm_columns()`](https://pbs-assess.github.io/sdmTMB/reference/add_utm_columns.md)
...
- `spatial_only` in
  [`sdmTMB()`](https://pbs-assess.github.io/sdmTMB/reference/sdmTMB.md)
  is now deprecated and replaced by `spatiotemporal`. E.g.
...
- Simulation from the parameter covariance matrix works if random
  ...
  [\#57](https://github.com/pbs-assess/sdmTMB/issues/57)
...
- Fix bug evaluating `...` when
  ...
  [\#54](https://github.com/pbs-assess/sdmTMB/issues/54)
...
- Added
  [`gather_sims()`](https://pbs-assess.github.io/sdmTMB/reference/gather_sims.md)
  and
  [`spread_sims()`](https://pbs-assess.github.io/sdmTMB/reference/gather_sims.md)
  to extract parameter simulations from the joint precision matrix in a
  format that matches the tidybayes package.

- Added
  [`get_index_sims()`](https://pbs-assess.github.io/sdmTMB/reference/get_index_sims.md)
  for a population index calculated from the MVN simulation draws.

- Added
  [`extract_mcmc()`](https://pbs-assess.github.io/sdmTMB/reference/extract_mcmc.md)
...
- Added priors for all parameters. See `?sdmTMB::priors` and the
  `priors` argument in
  [`sdmTMB()`](https://pbs-assess.github.io/sdmTMB/reference/sdmTMB.md).
  PC priors are available for the random fields. See
  [`?pc_matern`](https://pbs-assess.github.io/sdmTMB/reference/priors.md)
...
- Added back `normalize` argument to
  [`sdmTMB()`](https://pbs-assess.github.io/sdmTMB/reference/sdmTMB.md)
  and default to `FALSE`. Setting to `TRUE` can dramatically speed up
  some model fits (~4 times for some test models).
...
- Add IID random intercepts interface. E.g. `... + (1 | g)`
  [\#34](https://github.com/pbs-assess/sdmTMB/issues/34)
...
- Fixed parameter initialization for inverse links
  [\#35](https://github.com/pbs-assess/sdmTMB/issues/35)
...
- Allow specifying degrees of freedom in the Student-t family
  [\#29](https://github.com/pbs-assess/sdmTMB/issues/29)
...
- Barrier meshes are now possible. See
  [`add_barrier_mesh()`](https://pbs-assess.github.io/sdmTMB/reference/add_barrier_mesh.md)
  for an example.
...
- Add linear and logistic threshold models.
  [\#17](https://github.com/pbs-assess/sdmTMB/issues/17)

## sdmTMB 0.0.5.9000

- Added parsing of mgcv formulas for splines.
  [\#16](https://github.com/pbs-assess/sdmTMB/issues/16)

- Added ability to predict with standard errors at the population level.
  This helps with making marginal-effect plots.
  [\#15](https://github.com/pbs-assess/sdmTMB/issues/15)

- Added optimization options to aid convergence. Also added
  [`run_extra_optimization()`](https://pbs-assess.github.io/sdmTMB/reference/run_extra_optimization.md)

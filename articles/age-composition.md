...
about `sigma_Z` being less than 0.01; we’ve set it up that way on
purpose! Do check the output of
[`summary()`](https://rdrr.io/r/base/summary.html) though to make sure
*other* spatially varying SDs haven’t collapsed.

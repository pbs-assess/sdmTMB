...
models will be fit, but using this function may be worthwhile to reduce
coding errors (in the log-likelihood calculations). For example, here we
assign two folds, randomly holding out 10% of the observations as a test
set (the test set is given ID = 1, and the training set is given ID =
2).
...
#> 1  113.13848 32.922454028 POINT (446475.2 5793426)
#> 2   41.70492 19.626916220 POINT (446459.4 5800136)
#> 3    0.00000 15.231893857 POINT (448598.7 5801687)
#> 4   15.70614 68.680175641 POINT (436915.7 5802305)
#> 5    0.00000  8.842589030 POINT (420610.1 5771055)
#> 6    0.00000  1.911803370   POINT (417713 5772205)
#> 7    0.00000  0.002368993 POINT (408208.8 5771287)
#> 8    0.00000  0.009383742 POINT (408356.2 5766882)
#> 9    0.00000  0.862337421 POINT (414365.6 5760894)
#> 10  13.94762 10.813251985 POINT (400474.5 5749034)
```
...
#> 1 rmse    standard       28.0  <tibble [1 × 1]> <sf [100 × 5]> <tibble [0 × 2]>
#> 2 mae     standard       15.6  <tibble [1 × 1]> <sf [100 × 5]> <tibble [0 × 2]>
#> 3 rmse    standard        9.87 <tibble [1 × 1]> <sf [25 × 5]>  <tibble [0 × 2]>
#> 4 mae     standard        6.63 <tibble [1 × 1]> <sf [25 × 5]>  <tibble [0 × 2]>
#> 5 rmse    standard        7.86 <tibble [1 × 1]> <sf [4 × 5]>   <tibble [0 × 2]>
#> 6 mae     standard        5.59 <tibble [1 × 1]> <sf [4 × 5]>   <tibble [0 × 2]>
```

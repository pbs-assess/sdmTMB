...
If all we need are point predictions, we can just multiply the predictions from the two models:
...
However, more draws take longer to calculate and take more memory (larger matrix), so small number (~100) may be fine for experimentation. 

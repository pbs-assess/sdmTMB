...
**Note that this vignette was written prior to built-in delta/hurdle models in sdmTMB. You can now use a delta family such as `family = delta_gamma()`. This vignette will be updated soon.**
...
sdmTMB didn't used to have built-in hurdle models (also called delta models), but we could fit the two components separately and combine the predictions. 

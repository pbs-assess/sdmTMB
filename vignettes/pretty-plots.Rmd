...
We will multiply the `X` and `Y` columns by 1000 because we worked in UTM km for model fitting (to avoid computation issues with the scale of the range paramater:

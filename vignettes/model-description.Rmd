...
<!-- y_{s,t} &\sim \operatorname{Family} \left(\mu_{s,t}, \phi \right),\\ -->
<!-- \mu_{s,t} &= g^{-1} -->
...
\end{align}
$$
where $g$ is the link function and $g^{-1}$ is the inverse link.

## Time-varying regression parameters

$$
\begin{align}
  \mu_{s,t} &= \operatorname{link} \left( \ldots + \gamma_{t} x_{s,t} + \ldots \right),\\
...
$$
\begin{align}
  \mu_{s,t} &= \operatorname{link} \left( \ldots + \zeta_s x_t + \ldots \right),\\

...
`ggeffects::ggpredict()` can be used to make conditional effects plots of sdmTMB models, including models with smoothers (but not currently including delta models [due to a recent change in ggeffects](https://github.com/sdmTMB/sdmTMB/issues/435)).

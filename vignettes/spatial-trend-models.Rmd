...
```{r}
plot_map_raster(p2$data, "est_re_st") + scale_fill_gradient2()
plot_map_raster(p3$data, "est_re_st") + scale_fill_gradient2()
```

And the single spatial random effects for all three models:

```{r}
plot_map_raster(filter(p1$data, year == 2003), "est_re_s")
plot_map_raster(filter(p2$data, year == 2003), "est_re_s")
plot_map_raster(filter(p3$data, year == 2003), "est_re_s")
```

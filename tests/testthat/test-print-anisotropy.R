test_that("Print anisotropy prints correctly", {
  ...
  expect_output(cat(print_anisotropy(fit_dg_not_shared, m = 1)), regexp = "\\(spatial\\): 19.46 to 64.60 at 58.72")
  expect_output(cat(print_anisotropy(fit_dg_not_shared, m = 1)), regexp = "\\(spatiotemporal\\): 122.96 to 408.11 at 58.72")
  expect_output(cat(print_anisotropy(fit_dg_not_shared, m = 2)), regexp = "\\(spatial\\): 0.01 to 0.04 at 58.72")

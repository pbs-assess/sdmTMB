# Convert [`sdmTMB_cv()`](https://pbs-assess.github.io/sdmTMB/reference/sdmTMB_cv.md) objects to sf format for spatial assessment with waywiser
...
#> 1 rmse    standard       12.8  <tibble [1 × 1]> <sf [25 × 5]> <tibble [0 × 2]>
#> 2 mae     standard        9.23 <tibble [1 × 1]> <sf [25 × 5]> <tibble [0 × 2]>
#> 3 rmse    standard        7.79 <tibble [1 × 1]> <sf [4 × 5]>  <tibble [0 × 2]>
#> 4 mae     standard        6.42 <tibble [1 × 1]> <sf [4 × 5]>  <tibble [0 × 2]>
```

...
the default spatial correlation is isotropic, but anisotropy can be
enabled with `anisotropy = TRUE`. These plotting functions help
visualize that estimated anisotropy.

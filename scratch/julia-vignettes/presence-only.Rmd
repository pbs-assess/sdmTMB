...
There are several approaches to generating pseduo-absences from these data. We first use a method called quadrature points ([Renner et al. 2015](https://doi.org/10.1111/2041-210X.12352)). For this method, we have to decide:  
...
Several approaches exist for estimating a model with pseudo-absences. These are similar, but have different likelihood models. First, we can use an Infinitely Weighted Logistic Regression [Fithian & Hastie (2013)](https://doi.org/10.1214/13-AOAS667) for the model.

...
r2.sdmTMB <- function(x, which_fixef = NULL, method = NULL) {
  ...
  # }
  if (!x$family$family %in% c("student", "gaussian", "binomial", "tweedie")) {
    cli::cli_abort("r2.sdmTMB() currently only works for Gaussian, binomial, and Tweedie models.", call. = FALSE)
  }

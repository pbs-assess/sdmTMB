...
A major advantage to this approach over visreg, is that ggeffects calculates marginal effects with the effects package using the parameter covariance matrix. 
...
`ggeffects::ggpredict()` also does conditional effects, but this has not yet been set up in sdmTMB.

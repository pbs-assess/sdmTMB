...
(SDMs). See the [documentation
site](https://pbs-assess.github.io/sdmTMB/) and a preprint:
...
mesh via the fmesher or INLA packages and supplied it to
...
grid cell area 4 (2 x 2 km) and pass the predictions to
...
in [sdmTMBextra](https://github.com/pbs-assess/sdmTMBextra).
